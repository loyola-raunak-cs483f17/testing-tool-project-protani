...
/**
 * Test cases for trivia.ManyParameters
 */
public class ManyParametersTest1 extends edu.gatech.cc.junit.FilteringTestCase {
  ...
  protected String getNameOfTestedMeth() {
    return "trivia.ManyParameters.<init>";
  }
  
  /**
   * Constructor
   */
  public ManyParametersTest1(String pName) {
    super(pName);
  }
  ...
  public static junit.framework.Test suite() {
    return new junit.framework.TestSuite(ManyParametersTest1.class);
  }
  ...
  public static void main(String[] args) {
    junit.textui.TestRunner.run(ManyParametersTest1.class);
  }
}